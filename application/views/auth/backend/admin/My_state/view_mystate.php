    ...
    <div class="content-body">
        ...
        <section id="descriptioin" class="card">
            <div class="card-header">
             <a href="<?= base_url('Auth/Backend/My_state/add_video') ?>" class="btn btn-primary btn-sm pull-right">Add Video </a>
                 ...
                 <div class="search-panel">
                    <form class="form form-horizontal">
                        ...
                        <div class="col-md-3 no-padding">
                            <button type="submit" class="btn btn-primary cus-btn1" formaction="<?= base_url('Auth/Backend/My_state/search') ?>">
                                <i class="la la-search"></i>
                            </button>
                            <a class="btn btn-warning cus-btn1" href="<?= base_url('Auth/Backend/My_state/') ?>">
...
<script>
    ...
    function edit(value) {
        // alert(value);
        $.get("<?= base_url('Auth/Backend/My_state/edit_video/') ?>" + value, function (data) {
    ...
    function delete_data(value) {
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.ajax({url: "<?= base_url('Auth/Backend/My_state/delete_video/') ?>" + value, success: function (result) {
