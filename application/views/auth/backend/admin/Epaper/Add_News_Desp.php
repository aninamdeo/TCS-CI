...
{
    .addnewsdetail .card-header .btn
    {
        font-size: 12px;
    } 
    .addnewsdetail .form-control
    {
...
<div class="content-detached content-right addnewsdetail">
    <div class="content-body">
        <section id="descriptioin" class="card">
            <div class="card-header">
                  <a  class="btn btn-primary pull-right" href="<?= base_url('Auth/Backend/News_Desp') ?>"> View News Details </a>
                            ...
                            <div class="form-group row">
                             <div class="col-md-6">
                                     ...
                                     <select class="form-control" name="category" id="category" onchange="get_subcategory(this.value)" required="">
                                        ...
                                        <?php
                                           foreach ($category as $cat) {?>
                                            <option value="<?= $cat->id?>"><?= $cat->cat_name_hindi ;  ?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" name="title_hindi" id="ckeditor" required=""></textarea>
                                </div>
                                  <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" name="content_hindi" id="ckeditor2" required=""></textarea>
                                </div>
                             <!--    <div class="col-md-12">
