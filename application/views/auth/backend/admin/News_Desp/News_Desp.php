    ...
    <div class="content-body">
        ...
        <section id="descriptioin" class="card">
            <div class="card-header">
             <a href="<?= base_url('Auth/Backend/Category/')?>" class="btn btn-primary btn-sm pull-right">View Category</a>
                               ...
                               <tr>
                                ...
                                <td> 
                                    ...
                                    <a class="btn btn-danger cus-btn2" onclick="delete_data('<?= $value->id ?>')" href="#">
                                     ...
                                     <a class="btn btn-warning cus-btn2" href="<?= base_url('Auth/Backend/News_Desp/push_notify/'.$value->id) ?>">Pust Notify
                                    </a>
