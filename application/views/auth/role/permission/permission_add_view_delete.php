    ...
    <div class="content-body">
        <section id="descriptioin" class="card">
            <div class="card-header">
                <h4 class="card-title"><i class="ft-user"></i> Add-View Role Permissions</h4>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($value->role_aa_usertype_permission == 'Edit') {
                                            ?>
                                            <a class="btn btn-info cus-btn2" href="<?= base_url('Auth/Role/Permission/allot_module_permission/'.$value->role_aa_usertype_id) ?>" >
                                                <i class="la la-pencil"></i> Permission
                                            </a>
                                        <?php } ?>
                                        </td>
                                    </tr>
