<div class="content-detached content-right">
    <div class="content-body">
                    ...
                    <form class="form form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="form-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <button type="submit" class="btn btn-primary cus-btn" formaction="<?= base_url('Auth/Setting/Country/insert') ?>">
                                        Save
                                    </button>
        ...
        <section id="descriptioin" class="card">
            <div class="card-header">
                <h4 class="card-title"><i class="ft-user"></i> View Country</h4>
            </div>
            <div class="card-content">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            foreach ($values as $value) {
                                ...
                                <tr>
                                    <td><?= $n ?></td>
                                    <td><?= $value->common_ab_country_name ?></td>
                                    <td><span class="badge <?php echo $value->common_ab_country_status == 'Enabled' ? 'badge-primary' : 'badge-danger'; ?>"><?= $value->common_ab_country_status ?></span></td>
                                    <td><?= $value->common_ab_country_ordering ?></td>
                                    <td>
                                        <a class="btn btn-info cus-btn2" href="#" onclick="edit('<?= $value->common_ab_country_id ?>')">
                                            <i class="la la-pencil"></i>
                                        </a>
                                        <a class="btn btn-danger cus-btn2" onclick="delete_data('<?= $value->common_ab_country_id ?>')" href="#">
...
<script>
    function edit(value) {
        $.get("<?= base_url('Auth/Setting/Country/edit') ?>/" + value, function (data) {
    ...
    function delete_data(value) {
        swal({
            ...
            dangerMode: true,
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({url: "<?= base_url('Auth/Setting/Country/delete') ?>/" + value, success: function (result) {
