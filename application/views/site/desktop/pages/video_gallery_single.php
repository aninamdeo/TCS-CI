        ...
        <div class="row">
            <div class="col-sm-8">
                ...
                <section class="videogallery-single thumbnail">
                 ...
                 <p class="pull-left"><?= $video->short_description ?></p>
                 <div class="text-right pull-right">
                    ...
                    <ul class="custom-social" style="display:none;">
                        <li class="facebook"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?= base_url('Videos/news/'.$video->link) ?>"><i class="fa fa-facebook"></i></a></li>
                        <li class="twitter"><a target="_blank" href="#"><i class="fa fa-twitter"></i></a></li>
                        <li class="whatsapp hidden-xs"><a target="_blank" href="https://web.whatsapp.com/send?text=<?= base_url('Videos/news/'.$video->link)?>"><i class="fa fa-whatsapp"></i></a></li>
                        <li class="whatsapp visible-xs"><a target="_blank" href="whatsapp://send?text=<?= base_url('Videos/news/'.$video->link) ?>"><i class="fa fa-whatsapp"></i></a></li>
                    </ul>
                 </div>
            </div>
            ...
            <div class="col-sm-4">
                ...
                <div class="box media">
                    <div class="media-left">
                        <a href="<?= base_url('Videos/news/'.$data->link)?>">
                    ...
                    <div class="media-body media-middle">
                        <h5>
                            <a href="<?= base_url('Videos/news/'.$data->link)?>" class="pull-left"><span class="web-color"><?= $data->title ?> </span> <?= $data->title_hindi ?></a>
...
<ul class="singlenewsbottom-social visible-xs">
    ...
    <li class="facebook">
        <a href="https://www.facebook.com/sharer/sharer.php?u=<?= base_url('Videos/news/'.$video->link) ?>"><i class="fa fa-facebook"></i></a>
    </li>
    <li class="whatsapp"><a href="whatsapp://send?text=<?= base_url('Videos/news/'.$video->link) ?>"><i class="fa fa-whatsapp"></i></a></li>
