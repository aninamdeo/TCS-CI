    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="login-box">
                    <form action="<?= base_url('Web/mob_user_login')?>" method="post">
               ...
               <p>By proceeding, you agree to our <br/><a href="<?= base_url('Web/page/Terms')?>" class="link">Terms & Conditions</a> & <a href="<?= base_url('Web/page/Privacy')?>" class="link">Privacy Policy</a>
               </p>
            </div>
        </div>
    </div>
