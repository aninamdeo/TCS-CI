        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="login-box">
                    ...
                    <h4>User Name <a href="<?= base_url('Web/edit_profile')?>" class="btn btn-default web-btn"><i class="fa fa-pencil"></i></a></h4>                    
                    ...
                    <form action="">
                        ...
                        <div class="form-group">
                         ...
                         <a href="<?= base_url('Web/logout')?>" class="web-btn form-control btn-rounded" value="">Signout</a>
                    </form>
                </div>
            </div>
        </div>
