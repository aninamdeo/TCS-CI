            ...
            <div class="col-xs-12">
                <h5 class="front-news-heading">
                    ...
                    <ul class="custom-social" style="display:none;">
                        <li class="facebook"><a href="https://www.facebook.com/sharer/sharer.php?u=<?= base_url('Backend/single_gallery/'.$video->id.'/'.preg_replace('/-+/', '-',preg_replace('/[^A-Za-z0-9\-]/','-',$video->title_share))) ?>"><i class="fa fa-facebook"></i></a></li>
            ...
            <div class="col-xs-12">
                ...
                <div class="box media">
                    <div class="media-left">
                        <a href="<?= base_url('Backend/single_gallery/'.$data->id.'/'.preg_replace('/-+/', '-',preg_replace('/[^A-Za-z0-9\-]/','-',$data->title_share)))?>">
                    ...
                    <div class="media-body media-middle">
                        <h6>
                            <a href="<?= base_url('Backend/single_gallery/'.$data->id.'/'.preg_replace('/-+/', '-',preg_replace('/[^A-Za-z0-9\-]/','-',$data->title_share)))?>" class="pull-left"><span class="web-color"><?= $data->title ?> </span> <?= $video->title_hindi ?></a>
