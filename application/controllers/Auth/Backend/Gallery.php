...
class Gallery extends CI_Controller
{
    ...
    public function index($per_page = 20)
    {
        ...
        $paginate = $this->basic->create_links('Backend/Gallery/index/', $total, $per_page,6);
        $data['links'] = $paginate['links'];
        $data['photo_gallery_data']=$this->Query->select('*','photo_gallery','','',['id'=>'desc'],[$paginate['per_page'], $paginate['page']]);
        $this->load->view('auth/backend/admin/Gallery/Gallery',$data);
    ...
    public function add_gallery()
    {
        ...
        $this->load->view('auth/backend/admin/Gallery/Add_Gallery'); 
        $this->basic->footer($mid);
    }
    ...
    public function insert_gallery()
    {
      ...
      if ($qry == TRUE) {
        ...
        redirect('backend/Gallery/add_gallery');
    }
    ...
    {  
        ...
        $this->load->view('auth/backend/admin/Gallery/Edit_Gallery',$data);
    }
     ...
     public function video()
    {
        ...
        $this->load->view('auth/backend/admin/Gallery/video_gallery',$data);
        $this->basic->footer($mid);
    }
    public function add_video()
    {
        ...
        $data['permit'] = chk($mid, ['add']);
        $this->basic->header($mid, 'Front');
        $this->load->view('auth/backend/admin/Gallery/Add_video_gallery'); 
        $this->basic->footer($mid);
    }
  public function search1($per_page = 30) {
        ...
        $paginate = $this->basic->create_links('Backend/Gallery/video/', $total, $per_page, 6);
        $data['links'] = $paginate['links'];
    ...
    public function insert_video()
    {
       ...
       $qry= $this->Query->insert('video_gallery',$array);
        ...
        redirect('backend/Gallery/video');
    }
    ...
    {  
        ...
        $this->load->view('auth/backend/admin/Gallery/Edit_video_gallery',$data);
