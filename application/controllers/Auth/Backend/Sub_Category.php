...
class Sub_Category extends CI_Controller
{
    ...
    public function index($per_page = 30)
    {
        ...
        $paginate = $this->basic->create_links('Backend/Sub_Category/index/', $total, $per_page,6);
        ...
        $this->load->view('auth/backend/admin/Sub_Category/Sub_Category',$data);
    ...
    //     $this->load->view('auth/backend/admin/Sub_Category/Add_Sub_Category',$data);
    //     $this->basic->footer($mid);
    // }
    ...
    public function insert_sub_category()
    {
     ...
     // $this->Query->insert('sub_category',$array2);
       if ($qry == TRUE) {
        ...
        redirect('backend/Sub_Category/add_sub_category');
    }
 public function edit_sub_category($id)
  {  
     ...
     $this->load->view('auth/backend/admin/Sub_Category/Edit_Sub_Category',$data);
  }
