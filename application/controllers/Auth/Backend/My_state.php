...
class My_state extends CI_Controller
{
     ...
     public function index($per_page = 30)
    {
        ...
        $paginate = $this->basic->create_links('Backend/My_state/index', $total, $per_page,6);
        ...
        $this->load->view('auth/backend/admin/My_state/view_mystate',$data);
    ...
    public function add_video()
    {
        ...
        $this->load->view('auth/backend/admin/My_state/add_mystate',$data); 
        $this->basic->footer($mid);
    }
  ...
  {  
        ...
        $this->load->view('auth/backend/admin/My_state/edit_mystate',$data);
    }
