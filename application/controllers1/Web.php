...
class Web extends CI_Controller {
  ...
  public function auto_redirect(){
    ...
    $path = uri_string();
    $get_path = str_replace('Web','Seven_inews',$path);
...
public function index() {
  ...
  $data['news_data'] =  $this->Query->join($select,'news_details', $join_arr, ['news_details.top_news' => 'Yes','news_details.status' => 'Enabled','news_details.id !='=>$news->id],'result',['news_details.id'=>'desc'],'14');
  $data['interesting_data'] = $this->Query->join($select,'news_details', $join_arr, ['news_details.status' =>'Enabled','news_details.cat_id'=>'27'],'result',['news_details.id'=>'desc']);
  $data['bollywood_data'] = $this->Query->join($select,'news_details', $join_arr, ['news_details.status' =>'Enabled','news_details.cat_id'=>'20'],'result',['news_details.id'=>'desc'],'4');
  $data['bolly_sub_cat'] = $this->Query->select('*','sub_category',['status'=>'Enabled','cat_id'=>'20'],'result',['sub_ordering'=>'asc']);
